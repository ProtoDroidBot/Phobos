...
def _materialize(value, field_handlers=None):
    ...
    decoded. A handler receives the raw attribute value and returns the value
    retained in the materialized parent object. This allows large nested
    indexes to be consumed incrementally.
    """
...
def load_fsd_file(
    ...
    ``field_handlers`` can consume and replace selected object attributes
